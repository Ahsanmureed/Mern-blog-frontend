...
const Profile = () => {
  ...
  const fetchUser = async ()=>{
   try {
    const res=await axios.get("https://mern-blog-2gmm.vercel.app/api/v1/user/"+user._id,{withCredentials:true})
  ...
  const handleSunmit = async(e)=>{
    e.preventDefault();
    const res = await axios.put("https://mern-blog-2gmm.vercel.app/api/v1/user/"+user._id,{username,email,password},{withCredentials:true})
  }
  useEffect(()=>{
fetchUser()
  },[user])
